...
export LDFLAGS="-L$CURL_ROOT/lib"
./configure --prefix=%i --with-js-lib=$SPIDERMONKEY_ROOT/lib --with-js-include=$SPIDERMONKEY_ROOT/include --with-erlang=$ERLANG_ROOT/lib/erlang/usr/include --with-icu4c=$ICU4C_ROOT LDFLAGS="-L$CURL_ROOT/lib"
make %makeprocesses
